...
function health() {
  ...
  document.getElementById("content").innerHTML =
    "False information can be detramental to your health. For example, you notice that you have a few flu like symptoms. When you search for the symptoms using a search engine, you are given many different diagnosis that can be incorrect.";
...
function grades() {
  ...
  document.getElementById("content").innerHTML =
    "Have you ever had that informative paper you had to write in high school? When researching information, do you know if the information you are reading is correct or not? The information you turn in could make or break your grades. Knowing how to find factual information is crucial in getting that big paper perfect.";
...
function truth() {
  ...
  document.getElementById("content").innerHTML =
    "While watching your favorite news station or reading up on your favorite news paper, it can be difficult to know what is false or true news. When media gives out false news, you may believe everything that is being said and is causing you form a false mindset.";
...
function illusory() {
  ...
  document.getElementById("content").innerHTML =
    "The illusory truth effect is the tendency to believe false information to be correct after repeated exposure. When you are told the same information over and over again, you may begin to believe the information and spread it.";
...
function politics() {
  ...
  document.getElementById("content").innerHTML =
    "Many websites and news sources can direct information towards a certain politicial party. When watching the news, make sure to research the topic more by searching through different sources.";
